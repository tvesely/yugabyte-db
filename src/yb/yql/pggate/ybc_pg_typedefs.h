...
// Must match the definition in uuid.h
#define YBC_UUID_LEN 16

// TODO: duplicating the code for this datatype is a hack. Ideally, we would share headers,
//       and have interfaces for interracting with these datatypes in C++
